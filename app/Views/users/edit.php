<?php $title = 'Edit User - GymManager'; ?>
...
<div class="card">
    ...
    <div class="card-body">
        <form action="<?= URLROOT ?>/users/update/<?= $id ?>" method="post" data-validate>
            ...
            <div class="form-group">
                ...
                <input type="password" name="password" id="password" class="form-control <?= !empty($password_err) ? 'is-invalid' : '' ?>" data-validate-strength>
            ...
            <div class="form-group">
                ...
                <select name="role" id="role" class="form-control <?= !empty($role_err) ? 'is-invalid' : '' ?>" <?= $isSuperAdmin ? '' : 'disabled' ?> required>
                    ...
                    <?php else: ?>
                        <option value="<?= $role ?>" selected><?= ucfirst(strtolower($role)) ?></option>
                    <?php endif; ?>
                </select>
            ...
            <div class="form-group" id="tenant-group">
                ...
                <select name="tenant_id" id="tenant_id" class="form-control <?= !empty($tenant_id_err) ? 'is-invalid' : '' ?>">
